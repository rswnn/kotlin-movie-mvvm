...
import com.riswan.moviemvvm.data.api.TheMovieDBClient
...
class SingleMovie : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.networkState.observe(this, Observer {
            progress_bae.visibility = if (it == NetworkState.LOADING) View.VISIBLE else View.GONE
    ...
    fun bindUI(it: MovieDetails) {
        ...
        movie_price.text = formatCurrency.format(it.budget)
