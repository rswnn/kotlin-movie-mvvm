...
import com.riswan.moviemvvm.R
import com.riswan.moviemvvm.data.api.IMAGE_URL
import com.riswan.moviemvvm.data.repository.NetworkState
import com.riswan.moviemvvm.data.value_object.Movie
import com.riswan.moviemvvm.ui.single_movie_details.SingleMovie
    ...
    class NetWorkStateItemViewHolder(view:View): RecyclerView.ViewHolder(view) {
        fun bind(networkState: NetworkState?) {
            ...
            if (networkState != null && networkState == NetworkState.ERROR) {
                itemView.progress_bar_item.visibility = View.VISIBLE
                itemView.erro_msg_item.text = networkState.msg
            } else if (networkState != null && networkState == NetworkState.ENDOFFILE) {
                itemView.progress_bar_item.visibility = View.VISIBLE
                itemView.erro_msg_item.text = networkState.msg
            } else {
                itemView.erro_msg_item.visibility = View.GONE
            }
        }
    }
